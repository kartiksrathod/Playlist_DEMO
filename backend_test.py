...
# Configuration
BASE_URL = "https://audio-dash.preview.emergentagent.com/api"
UPLOADS_URL = "https://audio-dash.preview.emergentagent.com/uploads"
...
class MusicPlaylistAPITester:
    ...
    def test_static_file_serving(self, playlist_with_image):
        ...
        try:
            ...
            image_url = f"https://audio-dash.preview.emergentagent.com{playlist_with_image['coverImage']}"
    ...
    def test_image_deletion_on_update(self):
        ...
        try:
            ...
            initial_image_url = f"https://audio-dash.preview.emergentagent.com{playlist['coverImage']}"
            ...
            new_image_url = f"https://audio-dash.preview.emergentagent.com{updated_playlist['coverImage']}"
    ...
    def test_image_deletion_on_playlist_delete(self):
        ...
        try:
            ...
            playlist = response.json()
            playlist_id = playlist['id']
            image_url = f"https://audio-dash.preview.emergentagent.com{playlist['coverImage']}"
    ...
    def test_static_audio_file_serving(self, track_with_audio):
        ...
        try:
            ...
            audio_url = f"https://audio-dash.preview.emergentagent.com{track_with_audio['audioFile']}"
    ...
    def test_cascade_delete_playlist_with_tracks(self):
        ...
        try:
            ...
            for i in range(3):
                ...
                audio_urls.append(f"https://audio-dash.preview.emergentagent.com{track['audioFile']}")
