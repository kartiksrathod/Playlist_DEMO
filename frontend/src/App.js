...
import { ArrowRight, Music, ListMusic, Sparkles, Play, TrendingUp, LogIn } from 'lucide-react';
            ...
            <div className="App">
              ...
              <BrowserRouter>
                <Routes>
                  ...
                  <Route path="/library/track/:trackId" element={<ProtectedRoute><TrackDetail /></ProtectedRoute>} />
