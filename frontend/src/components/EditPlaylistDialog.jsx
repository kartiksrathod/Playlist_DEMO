...
const EditPlaylistDialog = ({ open, onOpenChange, playlist, onSuccess }) => {
  ...
  useEffect(() => {
    if (playlist) {
      ...
      if (playlist.coverImage) {
        setImagePreview(`${BACKEND_URL}${playlist.coverImage}`);
      } else {
        setImagePreview(null);
      }
      setCoverImage(null); // Reset new cover image
    }
  }, [playlist]);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Update your playlist details and cover image.
          </DialogDescription>
        </DialogHeader>
                ...
                <div className="relative">
                  ...
                  {!coverImage && (
                    <div className="absolute bottom-2 left-2">
                      <input
                        type="file"
                        id="edit-coverImage-change"
                        accept="image/*"
                        onChange={handleImageChange}
                        className="hidden"
                      />
                      <label htmlFor="edit-coverImage-change">
