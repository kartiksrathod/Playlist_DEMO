...
const EditTrackDialog = ({ open, onOpenChange, playlistId, track, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`${API}/playlists/${playlistId}/tracks/${track.id}`, formDataToSend, {
        headers: {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Update track information. You can change the audio source by providing a new URL or uploading a file.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              {track?.audioUrl && !track?.audioFile && !audioFile && (
                <div className="text-xs text-muted-foreground mb-2">
